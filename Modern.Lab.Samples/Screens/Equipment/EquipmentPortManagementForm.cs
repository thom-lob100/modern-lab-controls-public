...
namespace Modern.Lab.Samples
{
    ...
    public partial class EquipmentPortManagementForm : ModernFormBase
    {
        ...
        private void LoadDependents(string eqpId, bool silent)
        {
            ...
            this.LoadDependent(channelEqpHistory, () => this.RequestEqpHistory(eqpId), this.BindEqpHistory, silent, this.historyCover);
        }
        ...
        private void BindEqpHistory(DataTable history)
        {
            this.eqpHistoryData = history;

            EqpHistoryColumns(history).Bind(this.gridEqpHistory);
        }

        private void BindPortHistory(DataTable history)
        {
            this.portHistoryData = history;

            PortHistoryColumns(history).Bind(this.gridPortHistory);
        }
        ...
        private void ApplyPortSelection(bool silent)
        {
            ...
            this.LoadDependent(
                    ...
                    this.BindPortHistory, silent, this.historyCover);
        }
